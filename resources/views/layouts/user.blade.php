...
<head>
    ...
    <link rel="stylesheet" href="{{asset('css/styleUserAllDogs.css')}}">
    <link rel="stylesheet" href="{{asset('css/styleFavorite.css')}}">
    <link rel="stylesheet" href="{{asset('css/styleAdoptionUserForm.css')}}">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('user.showAllDogs') }}" class="nav-link">Psi</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('user.showfavoriteDogs') }}" class="nav-link">Favoriti</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('user.showAnsweredAdoptionRequests') }}" class="nav-link">Odgovoreni zahtjevi</a>
                        </li>
